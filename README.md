...
Content Based Recommender Systems recommends movies similar to the movie user likes and analyses the sentiments on the reviews given by the user for that movie.
...
## How to get that desired API key?
